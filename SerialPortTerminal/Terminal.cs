  ...
  public partial class frmTerminal : Form
  {
    ...
    private void SendData()
    {
      if (CurrentDataMode == DataMode.Text)
      {
        ...
        // Show in the terminal window the user's text
          if(chkCtrlZ.Checked)
              Log(LogMsgType.Outgoing, txtSendData.Text + Char.ConvertFromUtf32(26) + "\n");
          else
    ...
    private void btnOpenPort_Click(object sender, EventArgs e)
    {
      ...
      else
      {
        ...
        comport.PortName = "COM16"; //cmbPortName.Text;
    ...
    { e.Handled = KeyHandled; }
        ...
        public void htbSendSms()
        {
            ...
            //comport.Write("APZ&F" + (char)13);
            comport.Write("AT+CMGF=1" + (char)13); //este comando establece el modo texto
            System.Threading.Thread.Sleep(4000);
            comport.Write("AT+CMGS=" + (char)34 + "5515300895" + (char)34 + (char)13);
            System.Threading.Thread.Sleep(1000);
            comport.Write("Hola alfredo cvv" + (char)26 + System.Environment.NewLine);
            //System.Threading.Thread.Sleep(4000);
        }
	}
